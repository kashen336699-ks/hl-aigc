...
phase('Execute');
const ROLE_AGENT = { frontend: 'yd-frontend-engineer', backend: 'yd-backend-engineer', database: 'yd-database-engineer' };
const TASK_SCHEMA = {
  type: 'object',
  additionalProperties: false,
...
返回 {taskId, verdict, issues, p0Issues, summary}。`,
    { label: `review:${t.id}`, phase: 'Review', schema: REVIEW_SCHEMA, agentType: 'yd-code-reviewer' },
  );
}
